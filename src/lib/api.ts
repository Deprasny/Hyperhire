...
export async function getPageData(): Promise<PageData> {
  // In a real app, use an absolute URL env var.
  // For this demo, we'll try to fetch from localhost:3000
  // If it fails, we return fallback data to prevent build errors in this environment.
  try {
